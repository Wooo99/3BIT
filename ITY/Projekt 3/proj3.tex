...
\begin{document}
	...
	\begin{landscape}
		\begin{figure}[h]
			...
			\end{picture}
			\caption{Vektorový obrázek mdoerního bydlení vhodného pro 21. století.(Buď to vytvořte stejný obrázek, anebo nakreslete pomocí \texttt{ picture } váš vlastní domov.)}
		\end{figure}
	\end{landscape}
